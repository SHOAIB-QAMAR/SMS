...
<option value="ukg">ukg</option>
      ...
      <div class="notice-send">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" id="sends">
          Send Notice <i class='bx bxs-send'></i>
        </button>
      </div>
