                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control" id="editDOB"
                                        acceptaria-describedby="emailHelp" name="dob" required>
                                    <div class="invalid-feedback">
                                        required!
                                    </div>
                                </div>
                                <div class="col-6 student-image">
                                    ...
                                    <select class="form-select" id="editGender" name="gender" style="width:100%;"
                                        required>
                                ...
                                <div class="student-btns">
                                    ...
                                    <div class="dropdown dropdown-center">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item submit-attendence" id="remove_pic"
                                                    onclick="removeProfilePic()">Remove Profile Picture</a></li>
                                            <li><a class="dropdown-item reset-attendence" id="_change_password">Change
                                                    Password</a></li>
                                            <li><a class="dropdown-item reset-attendence" id="_change_profile">Edit
                                                    Profile</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5 col-xl-4">
                                            ...
                                            <div class="text-center mt-3 mb-3">
                                                ...
                                                <div id="profileImageBox">
                                                    <img alt="Profile Pic" src="../images/user.png"
                                                        ...
                                                        height="128" id="profile-image-user">
                                                </div>
                                        ...
                                        <div class="setting-function-btns mt-8 mb-5">
                                            ...
                                            <button class="btn btn-primary mb-3" id="showEditDialogBtn"> <i
                                                ...
                                                <form>
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            ...
                                                            <div class="user-info">
                                                                <h4 class="_flex-container"><i
                                                                        class='bx bxs-calendar'></i>&nbsp;&nbsp;BirthDay
                                                                </h4>
                                                                <h3>-</h3>
                                                            ...
                                                            <div class="user-info">
                                                                <h4 class="_flex-container"><i
                                                                        class='bx bx-phone-call'></i>&nbsp;&nbsp;Phone
                                                                </h4>
                                                                <h3>-</h3>
                                                            ...
                                                            <div class="user-info">
                                                                <h4 class="_flex-container"><i
                                                                        class='bx bx-male-female'></i>&nbsp;&nbsp;Gender
                                                                </h4>
                                                                <h3>-</h3>
                                                            ...
                                                            <div class="user-info">
                                                                <h4 class="_flex-container"><i
                                                                        class='bx bxs-home-alt-2'></i>&nbsp;&nbsp;Address
                                                                </h4>
                                                                <h3>-</h3>
