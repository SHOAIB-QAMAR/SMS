...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('../assets/loadProfilePic.php', {
        ...
        .then(data => {
            const profilePic = document.getElementById("navbar_profile_pic");
            if (!profilePic) return;

            if (data['status'] === "success") {

                profilePic.innerHTML = data['data'];
            } else {

                profilePic.innerHTML = '<img src="../images/user.png" >';
            }
...
const searchBtnNav = document.getElementById("topMostSearchBarBtn");
if (searchBtnNav) {
    searchBtnNav.addEventListener('click', () => {
        searchFunction();
        if (searchInput) searchInput.classList.remove("redColorText");
    });
}
...
const unknownForm = document.getElementById("unknowingForm");
if (unknownForm) {
    unknownForm.addEventListener('submit', function (event) {
