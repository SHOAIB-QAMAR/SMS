-- ============================================================
-- Grassroots Public School — Complete Database Schema
-- ============================================================
--
-- Usage:
...
-- ============================================================
-- SECTION 1: Public Website Tables (grassroot DB)
-- ============================================================
-- Used by: index.php, view_course.php, generate_pdf.php
...
INSERT INTO homepage_banner (id, filename) VALUES (1, 'assets/images/image1.jpeg')
ON DUPLICATE KEY UPDATE filename=filename;


-- ============================================================
-- SECTION 2: Panel / Management System Tables (sms DB)
-- Used by: panel/* (admin, teacher, student, owner panels)
-- Source: _sms.sql (phpMyAdmin dump, Jun 19 2024)
-- ============================================================
...
CREATE TABLE `bus_root` (
  `s_no` int(11) NOT NULL,
  `bus_id` varchar(20) NOT NULL,
  `location` varchar(255) NOT NULLpanel/assets/noSessionRedirect.php,
