<?php
session_start();
include("db.php"); // This now points to 'sms' database

// Using 'username' from anshi.php form as 'email' for the Dashboard table
...
if (mysqli_num_rows($result) == 1) {
    ...
    if (password_verify($password, $row['password_hash']) || $password === $row['password_hash']) {
        ...
        echo "Invalid Password. <a href='anshi.php'>Try again</a>";
    }
} else {
    echo "User not found. <a href='anshi.php'>Try again</a>";
}
?>